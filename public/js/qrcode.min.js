/**
 * EasyQRCodeJS / QRCode.js standalone browser generator
 */
(function(global){
  ...
  // Pure Canvas/DataURI Renderer with Chrome Lonely T-Rex in the center
  global.generateClientQrDataUri = function(text, callback) {
    try {
      var qr = new QRCodeGenerator(6, 2);
      qr.addData(text);
      qr.make();
      ...
      // Draw Center White Badge for Chrome Lonely T-Rex
      var badgeSize = Math.floor(canvas.width * 0.26);
      var badgeX = (canvas.width - badgeSize) / 2;
      var badgeY = (canvas.height - badgeSize) / 2;
      var radius = 10;
      ...
      // Pixel-art Chrome Lonely T-Rex Sprite Matrix
      var trexSprite = [
        "        ########    ",
        "       ##########   ",
        "       ## #######   ",
      ...
      var pSize = Math.max(2, Math.floor(badgeSize / 24));
      var spriteW = 20 * pSize;
      var spriteH = 19 * pSize;
      var startX = (canvas.width - spriteW) / 2;
      var startY = (canvas.height - spriteH) / 2;

      ctx.fillStyle = "#5f6368";
      for (var r = 0; r < trexSprite.length; r++) {
        for (var c = 0; c < trexSprite[r].length; c++) {
          if (trexSprite[r][c] === '#') {
      ...
      ctx.fillStyle = "#ffffff";
      ctx.fillRect(startX + 10 * pSize, startY + 2 * pSize, pSize, pSize);

      var syncUri = canvas.toDataURL("image/png");
      ...
      img.onload = function() {
        ...
        var iconPad = 8;
        ctx.drawImage(img, badgeX + iconPad, badgeY + iconPad, badgeSize - iconPad * 2, badgeSize - iconPad * 2);
        if (typeof callback === 'function') {
          callback(canvas.toDataURL("image/png"));
        }
      };
      img.src = "/images/t_rex.png";

      return syncUri;
    } catch (e) {
      console.error("Client QR generation error:", e);
      return null;
    }
  };
